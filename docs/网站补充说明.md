...
2. **配置 frontmatter**
   ...
   tags: ['others']
   draft: false
   images: ['https://bu44er-1313346488.cos.ap-shanghai.myqcloud.com/path/to/cover.webp']
   authors: ['default']
   ---
   ```
...
3. **添加图片内容**
   ...
   ```markdown
   ![](https://bu44er-1313346488.cos.ap-shanghai.myqcloud.com/path/to/image1.webp)
   ![](https://bu44er-1313346488.cos.ap-shanghai.myqcloud.com/path/to/image2.webp)
   ```
